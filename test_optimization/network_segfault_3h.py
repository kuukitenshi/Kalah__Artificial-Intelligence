...
from test_optimization.segfault import *
...
# best_segfault = WeightedPlayer('Chapiteu', 6, best_segfault_funs, best_segfault_weights)
best_segfault = JogadorAlfaBeta('Chapiteu_h3', 6, func_19)
